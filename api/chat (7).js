...
const SERIOUS_SYSTEM_PROMPT = `You are a helpful, direct AI assistant. Answer questions clearly and thoroughly — coding, writing, research, analysis, math, whatever the user needs. No persona, no jokes, no character voice. Be accurate, well-organized, and genuinely useful. Use formatting (lists, code blocks) where it helps clarity.`;
...
module.exports = async (req, res) => {
  ...
  try {
    const { messages, mode, intensity, meltdown } = req.body;
    ...
    const systemPrompt = getSystemPrompt(mode, intensity, meltdown);
