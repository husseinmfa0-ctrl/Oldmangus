...
module.exports = async (req, res) => {
  ...
  try {
    const { messages, mode, intensity } = req.body;
    ...
    const systemPrompt = getSystemPrompt(mode, intensity);
